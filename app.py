...
# Configure middleware to handle CORS, allowing requests from my origin
app.add_middleware(
    CORSMiddleware,
...
# Route to handle form submission amd make predictions
@app.post("/")
async def predictRouteClient(request: Request):
    ...
    try:
        ...
        # Convert from data into a DataFrame for the model
