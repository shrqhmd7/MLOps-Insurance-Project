...
class ModelTrainer:
    def __init__(self, data_transformation_artifact: DataTransformationArtifact,
        ...
        """
        :param data_transformation_artifact: Output refernce of dtaa transformation artifact stage
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            # Splitting the train and test data into features and target_variables
            x_train, y_train, x_test, y_test = train[:, :-1], train[:, -1], test[:, :-1], test[:, -1]
            logging.info("Train-Test split done.")

            # Initialise the RandomForestClassifier with specified parameters
            ...
            # Fit the model
            logging.info("Model training is going on...")
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        Description: This fucntion initiates the model training steps
        ...
        try:
            ...
            logging.info("Saved final object model that includes both preprocessing and the trained model.")
