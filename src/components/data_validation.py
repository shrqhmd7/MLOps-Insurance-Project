...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: DataFrame) -> bool:
        ...
        Output      : True or False (Returns bool value based on validation results)
        On Failure  : Write an exception log and then raisre an exception 
        """
        try:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        Description: This methos indicates the data validation components for the pipeline
        ...
        try:
            ...
            validation_report = {
                "validation_staus": validation_status,
            ...
            logging.info(f"Data Validaiton artifact created and saved to JSON file.")
