...
class SimpleStorageService:
    ...
    def get_file_object(self, filename: str, bucket_name: str) -> Union[List[object], object]:
        ...
        Returns:
            Union[List[object], object]: The S3 file object method of SimpleSktorageService class
        """
    ...
    def upload_file(self, from_filename: str, to_filename: str, bucket_name: str, remove: bool = True):
        ...
        Args:
            ...
            to_filename (str): Target file apth in the bucket
            bucket_name (str): Name of the S3 bucket
    ...
    def upload_df_as_cv(self, data_frame: DataFrame, local_filename: str, bucket_filename: str, bucket_name: str) -> None:
        """
        Uploads a DataFrame as a CSV file to the specified S3 bucket.

        Args:
            data_frame (DataFrame): The DataFrame to be uploaded.
            local_filename (str): Temporary local filename for the DataFrame
            bucket_filename (str): Target filename in the bucket
            bucket_name (str): Name of the S3 bucket
        """
        logging.info("Entered the upload_df_as_cv method of SimpleStorageService Class")
        try:
